...
| 2 | **Date window only on slide 1.** Slides 2/6 show counts (167,819 / 43% / 6,094) with no "Jan 30–Jun 8" qualifier visible; a reader who enters via deep-link (`#insight2`) sees no window at all. | 3 (recency) | MEDIUM | Open |
